...
function closeIssues(octokit, numbers) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return numbers.map((number) => __awaiter(this, void 0, void 0, function* () {
            ...
            return octokit.issues.update(Object.assign({}, context.repo, { state: 'closed' }));
        }));
    });
}
...
function getIssueNumbers(octokit, searchQuery) {
    return __awaiter(this, void 0, void 0, function* () {
        const context = github.context;
        const { data: data } = yield octokit.graphql(query, { query: `repo:${formatNameWithOwner(context.repo)} ${searchQuery}` });
